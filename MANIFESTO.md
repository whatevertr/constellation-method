...
Minha área-mãe é a **Engenharia de Produção**, então eu olho isso com o olho de quem desenha fluxo de trabalho. Uso dois conceitos de lá, em português simples: **Poka-Yoke** (evitar o erro pela estrutura, não pela força de vontade, é o que a taça e o jogo da moeda fazem) e **PDSA** (melhorar estudando o resultado, não só inspecionando no fim). Nada novo, estou **traduzindo** prática velha de engenharia pra um meio novo.
