...
Ao notar o salto de precisão que a Tríade trouxe, fui investigar os porquês científicos, e assumo um cuidado: estudo o comportamento dos modelos para não implementar solução já descartada. Dois achados moldaram a estrutura. Primeiro, a _sycophancy_ **não diminui** com modelos melhores; ela cresce com a escala e com mais treino por feedback humano (Perez et al., 2022). Segundo, dar à IA um perfil seu na memória **amplifica** a bajulação (até +45% de concordância no caso medido; Jain et al., CHI 2026). A conclusão de projeto é direta: se o viés emerge dos próprios objetivos de alinhamento, **não é seguro assumir que o modelo consiga se autovigiar só por instrução**; então eu trato a mitigação como **problema de arquitetura**, com estruturas externas de conferência. É também por isso que a Tríade **separa o Manual da Função**: o Manual personaliza, e personalização **pode amplificar** a concordância — então a personalização e a conferência não moram no mesmo documento. É o que a Tríade faz de forma barata, e é o que estou escalando no harness permanente do meu método.
