# Referências — base de pesquisa da Tríade de Contexto
...
> ⚠️ **Disclaimer (anti-overclaiming).** As dimensões ancoram em construtos validados; os itens de elicitação (as perguntas-cenário) são adaptações de item único criadas pela autora, sem validação psicométrica própria.
...
| 3. Cautela ao fechar | Falta de premeditação (UPPS) + Fear of Invalidity | UPPS; PFI | Whiteside & Lynam (2001); Thompson et al. (2001) |
...
> **Nota sobre a dimensão 3 (UPPS × UPPS-P).** A skill usa apenas a faceta **(falta de) premeditação**, que já existe na **UPPS** original de 4 fatores — por isso a referência é Whiteside & Lynam (2001). A **UPPS-P** de 5 fatores (que acrescenta a *urgência positiva*) é de Lynam, Smith, Whiteside & Cyders (2006), relatório técnico da Purdue University, sem DOI registrado. Como a urgência positiva **não** é usada por nenhuma dimensão, essa referência não entra na lista — pelo mesmo critério que exclui referências sem função.
...
- **Começar pelo essencial (bottom-line primeiro):** o lastro principal é o **princípio de sinalização** (*signaling*) — antecipar e destacar a estrutura essencial melhora a aprendizagem: Mautone & Mayer (2001), com meta-análise de Schneider, Beege, Nebel & Rey (2018). Apoio complementar no **efeito de níveis da macroestrutura** (informação superordenada é retida melhor que a subordinada): Kintsch & van Dijk (1978). Os *advance organizers* de Ausubel (1960) apontam na mesma direção, mas com efeito modesto na meta-análise de Luiten, Ames & Ackerson (1980) — entram como apoio histórico secundário, não como base. Já a segunda metade da regra ("a profundidade é liberada pela dimensão 1, não é o padrão") apoia-se em Cacioppo et al. (1996) e em Kalyuga (2007).
...
- **Modelo de difusão (Ratcliff & McKoon, 2008):** modelo de processo para tempo de resposta em decisões de duas alternativas — descreve *mecanismo* de decisão em tarefa de laboratório, não uma preferência de trabalho mensurável por autorrelato. Não sustenta nenhuma dimensão nem regra da skill; por isso saiu da lista.
- **Given-new contract (Clark & Haviland):** trata do encadeamento entre informação dada e nova *dentro da frase*, não da ordem "essencial primeiro" no documento — não sustenta a Regra 5.
...
Block, J., Block, J. H., & Harrington, D. M. (1974). Some misgivings about the Matching Familiar Figures Test as a measure of reflection–impulsivity. *Developmental Psychology, 10*(5), 611–632. https://doi.org/10.1037/h0037047
...
Diab, D. L., Gillespie, M. A., & Highhouse, S. (2008). Are maximizers really unhappy? The measurement of maximizing tendency. *Judgment and Decision Making, 3*(5), 364–370. https://doi.org/10.1017/S1930297500000383
...
Luiten, J., Ames, W., & Ackerson, G. (1980). A meta-analysis of the effects of advance organizers on learning and retention. *American Educational Research Journal, 17*(2), 211–218. https://doi.org/10.3102/00028312017002211
...
Peterson, E. R., Deary, I. J., & Austin, E. J. (2003). The reliability of Riding's Cognitive Style Analysis test. *Personality and Individual Differences, 34*(5), 881–891. https://doi.org/10.1016/S0191-8869(02)00116-2

Rietzschel, E. F., De Dreu, C. K. W., & Nijstad, B. A. (2007). Personal need for structure and creative performance: The moderating influence of fear of invalidity. *Personality and Social Psychology Bulletin, 33*(6), 855–866. https://doi.org/10.1177/0146167207301017
